...
const items = ref<DropdownMenuItem[][]>([
  ...
  [
    {
      label: "UNIVERS PHOTO & VIDEO",
      children: [
        [
          { label: "Appareil Photo" },
          { label: "Objectifs" },
          {
            label: "Éclairages & Studio",
            children: [
              [
                { label: "Fond & Supports" },
                { label: "Torches Vidéo" },
  ...
  [
    {
      label: "IMPRIMANTE & SCANNER & TRACEUR",
      children: [
        [
          {
            label: "Imprimante",
            children: [
              [
                { label: "Imprimante à Réservoir Rechargeable" },
