...
export function useStoreSettings() {
  ...
  async function load() {
    ...
    const flashEnabled = typeof flashEnabledRaw === "boolean" ? flashEnabledRaw : flashEnabledRaw === 1 || flashEnabledRaw === "1";
    storeSettings.value = {
      ...
      flash_sales_expires_at: typeof s["flash_sales.expires_at"] === "string" ? (s["flash_sales.expires_at"] as string) : undefined,
